    ...
    <div class="container-fluid">
        <div class="row">
            <div class="header-nav-wrapper">
                <div class="carousel-cell" style="background-image: url(img/attendance1.png);">
                    <div class="logo">
                    </div>
                    <div class="primary-nav-wrapper">
                        ...
                        <div class="login-page">
                            <p style="font-size: 35px; color: #414a52; text-align: center; text-shadow: 2px 2px #6B7E7F"> Check Attendance</p><br><br>
                            <div class="form">
